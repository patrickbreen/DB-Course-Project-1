...
class MovieDB
{
    ...
    public static void main (String [] args)
    {
        ...
        out.println ();
        Table t_select = movie.select (p -> p[movie.col("title")].equals ("Star_Wars") &&
                                            p[movie.col("year")].equals (1977));
        t_select.print ();

        //--------------------- indexed select
        
        out.println ();
        out.println (new KeyType ("Harrison_Ford").hashCode());
        out.println ();
        ...
        out.println ();
        Table tab = movie.indexedJoin ("title", "title", cinema);
        tab.print ();
        
        //movie.rangeSelect(new KeyType("Rambo"), movie.index.lastKey()).print();
